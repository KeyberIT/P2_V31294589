...
const {CLAVESITIO,CLAVESECRETA,GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET,EMAIL,PASSWORD} = process.env;
...
router.get('/autenticacionR',(req,res)=>{
...
//////////////////////////////////////////////////////////
router.get('/protectedd',(req,res)=>{
  const dato = req.query.datos;
...
router.post('/login',async(req,res)=>{
  ...
  res.json({interruptor:true,datos});
  }else{
